...
def eztv_shows_by_letter(letter):
    ...
    from koditorrent.scrapers import ungenerate
    from koditorrent.utils import terminating, url_get, SafeDialogProgress
    from koditorrent import tvdb
...
def eztv_get_show_seasons(show_id):
    ...
    from concurrent import futures
    from koditorrent.utils import first, terminating, url_get
    from koditorrent import tvdb
