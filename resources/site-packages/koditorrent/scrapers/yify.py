...
@scraper("Movies", "http://i.imgur.com/PrwiRH8.png")
@plugin.route("/yify")
@ensure_fanart
@tracked
def yify_index():
...
def yify_show_data(callback):
    ...
    from koditorrent.utils import url_get_json, terminating, SafeDialogProgress
...
def yify_search():
    ...
    if query:
        ...
        query = plugin.keyboard("", "koditorrent - YIFY - Search")
    if query:
